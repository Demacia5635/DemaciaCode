...
/**
 * Config for a {@link frc.demacia.RobotPose.Vision.VisionTypes.LimelightTagCamera3d}. The
 * offset is sent to the Limelight at startup as its camera pose in robot space.
 */
