...
public class VisionConstants {
    ...
    public static final Matrix<N3, N1> BACK_2D_STD = new Matrix<>(new SimpleMatrix(new double[] { Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY }));  // TODO tune; infinite = ignored
    ...
    public static final Transform3d BACK_3D_OFFSET = new Transform3d(
        new Translation3d(0.0, 0.0, 0.0),  // TODO
        new Rotation3d(0.0, 0.0, 0.0));  // TODO
    public static final Matrix<N3, N1> BACK_3D_STD = new Matrix<>(new SimpleMatrix(new double[] { Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY }));  // TODO tune; infinite = ignored
    ...
    public static final Matrix<N3, N1> BACK_3D_2_STD = new Matrix<>(new SimpleMatrix(new double[] { Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY }));  // TODO tune; infinite = ignored
    ...
    public static final Transform3d QUEST_OFFSET = new Transform3d(
        new Translation3d(0.0, 0.0, 0.0), 
        new Rotation3d(0.0, 0.0, 0.0)); 
    public static final Matrix<N3, N1> QUEST_STD = new Matrix<>(new SimpleMatrix(new double[] { Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY }));  // TODO tune; infinite = ignored
