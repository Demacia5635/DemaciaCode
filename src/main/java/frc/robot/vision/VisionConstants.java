...
public class VisionConstants {
    ...
    public static final Transform3d BACK_3D_OFFSET = new Transform3d(
        new Translation3d(0.0, 0.0, 0.0),  // TODO
        new Rotation3d(0.0, 0.0, 0.0));  // TODO
    public static final Matrix<N3, N1> BACK_3D_STD = new Matrix<>(new SimpleMatrix(new double[] { 0.3, 0.3, Double.POSITIVE_INFINITY }));  // TODO
    ...
    public static final Matrix<N3, N1> BACK_3D_2_STD = new Matrix<>(new SimpleMatrix(new double[] { 0.3, 0.3, Double.POSITIVE_INFINITY })); 
